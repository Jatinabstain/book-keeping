    ...
    return (
        <section className="mx-auto max-w-[1400px] px-[15px] w-full pt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-10 gap-6">
                ...
                <div className="md:col-span-4 bg-white shadow p-6">
                    {/* Header */}
                    ...
                    <div className="mb-6">
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-center justify-between p-3">
                                ...
                                <span className="text-sm font-semibold text-gray-700">$459,062.49</span>
                            </li>
                            <li className="flex items-center justify-between p-3 bg-gray-50 border rounded-md">
                                <div>
                                    <p className="font-medium text-blue-700">Stripe Merchant</p>
                                    <p className="text-xs text-gray-400">Updated 12 days ago</p>
                                </div>
                                <span className="text-sm font-semibold text-gray-700">$13,312.99</span>
                            </li>
                        </ul>
                    </div>
