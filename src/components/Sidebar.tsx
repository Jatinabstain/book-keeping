            ...
            <section className="sidebar sticky top-0 flex-col shrink-0 hidden lg:flex w-64 bg-white border-r">
                ...
                <div className="relative inline-block text-left px-4 pb-4">
                    ...
                    {isOpen && (
                        ...
                        >
                            <li>
                                <Link href="/dashboard/profile" className="dropdown-item block px-4 py-2 hover:bg-gray-700">
                                    Profile
                                </Link>
                            </li>
                            <li>
                                <Link href="/" className="dropdown-item block px-4 py-2 hover:bg-gray-700">
                                    Logout
                                </Link>
                            </li>
                        </ul>
