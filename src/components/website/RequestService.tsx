        ...
        <section id="request-service" className="bg-white py-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {services.map(({ name, icon: Icon }) => (
                        <div
                            ...
                            className="group bg-gray hover:bg-white transition border border-gray-200 hover:shadow-xl rounded-0 p-6 relative overflow-hidden hover:border-[#00799c] cursor-pointer"
                        >
            ...
            {selected && (
                <div className="fixed inset-0 z-50 flex justify-end">
                    ...
                    />
                    <div className="relative w-full max-w-md h-full bg-white shadow-xl px-6 py-4 animate-slideIn overflow-y-auto">
                        <button
                            onClick={() => setSelected(null)}
                            className="absolute top-5 right-6 text-gray-400 hover:text-gray-600 cursor-pointer"
                            aria-label="Close"
                        >
                            <X className="w-7 h-7" />
                        </button>

                        <h3 className="text-2xl font-semibold mb-3">Request {selected}</h3>
                        ...
                        <form className="space-y-4">
                            <input
                                ...
                                className="w-full border border-gray-300 px-4 py-3 text-sm focus:ring-blue-500 focus:outline-none"
                            />
                            <input
                                type="email"
                            ...
                            <textarea
                                ...
                                className="w-full border border-gray-300 px-4 py-3 text-sm h-24 resize-none focus:ring-blue-500 focus:outline-none"
                            />
                            <button
                                type="submit"
                                className="w-full inline-block bg-primary text-white font-medium px-6 py-2.5"
                            >
                                Submit Request
                            </button>
                        </form>
